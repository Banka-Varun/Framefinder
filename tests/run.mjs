...
for (const entry of ['api','navigation','social-features','turso-platform','google-link','profile-ticket','menu-usernames','product-update','member-controls','workspace-update','member-experience']) {
